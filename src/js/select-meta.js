...
uis.controller('uiSelectCtrl',
  ...
  ctrl.activate = function(initSearchValue, avoidReset) {
    if (!ctrl.disabled  && !ctrl.open) {
      ...
      ctrl.activeIndex = ctrl.items && (ctrl.activeIndex >= ctrl.items.length) ? 0 : ctrl.activeIndex;
  ...
  function _handleDropDownSelection(key) {
    ...
    switch (key) {
      case KEY.DOWN:
        ...
        else if (ctrl.items && (ctrl.activeIndex < ctrl.items.length - 1)) { ctrl.activeIndex++; }
        break;
      case KEY.UP:
        if (!ctrl.open && ctrl.multiple) ctrl.activate(false, true); //In case its the search input in 'multiple' mode
  ...
  ctrl.searchInput.on('keydown', function(e) {
    ...
    $scope.$apply(function() {
      ...
      if ((ctrl.items && ctrl.items.length > 0) || ctrl.tagging.isActivated) {
    ...
    if(KEY.isVerticalMovement(key) && ctrl.items && ctrl.items.length > 0){
